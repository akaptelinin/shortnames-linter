...
Also: the function header might scroll off-screen while you're eating a burger 🍔. You might be reviewing a PR at 11pm, drunk. In all these cases, `uploader.Process(config)` saves you,  `u.P(c)` — does not.
