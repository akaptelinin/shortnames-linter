...
Also: your monitor might scroll the function header off-screen. You might be eating a burger 🍔. You might be reviewing a PR at 11pm, drunk. In all these cases, `user.Process(ctx)` saves you, but `u.P(c)` doesn't.
